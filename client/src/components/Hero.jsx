      ...
      >
        <div>
          ...
          <input
            ...
            id="destinationInput"
            type="text"
            className="rounded border border-gray-300 px-3 py-1.5 mt-1.5 text-sm outline-none"
        ...
        <button className="flex items-center justify-center gap-1 rounded-md bg-black py-1.5 px-4 text-white cursor-pointer">
